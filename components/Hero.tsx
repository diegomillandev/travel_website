    ...
    <section className="max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row ">
      ...
      <div className="relative z-20 flex flex-col flex-1 xl:w-1/2">
        <Image
          ...
          width={50}
          height={50}
          className="absolute left-[-0.3125rem] top-[-1.875rem] w-10 lg:w-[50px]"
        />
      ...
      <div className="relative flex flex-1 items-start">
        <div className="relative z-20 flex w-[16.75rem] flex-col gap-8 rounded-3xl bg-green-90 px-7 py-8">
