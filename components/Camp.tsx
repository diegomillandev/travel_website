    ...
    >
      <div className="flex flex-col h-full items-start justify-between p-6 lg:px-20 lg:py-10 ">
        ...
        <div className="flexCenter gap-6">
          ...
          <p className="bold-16t md:bold-20 text-white -ml-2">{peopleJoined}</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <section className=" 2xl:max-container relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20 ">
      ...
      <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
        <div className="bg-green-50 p-8 lg:max-w-[31.25rem] xl:max-w-[45.875rem] xl:rounded-5xl xl:px-16 xl:py-20 relative w-full overflow-hidden rounded-3xl">
